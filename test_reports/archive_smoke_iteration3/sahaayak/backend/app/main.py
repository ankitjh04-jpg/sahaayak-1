...
from .api import auth, fields, advisories, experts, uploads, health, notifications
...
app.add_middleware(CORSMiddleware, allow_origins=[FRONTEND_ORIGIN], allow_credentials=False, allow_methods=['GET', 'POST', 'OPTIONS'], allow_headers=['Authorization', 'Content-Type'])
for module in [auth, fields, advisories, experts, uploads, health, notifications]: app.include_router(module.router, prefix='/api/v1')